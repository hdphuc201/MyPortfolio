...
const AboutMe = () => {
    const handleDownload = (item) => {
        const filePath ='/files/HuynhDuyPhuc_FrontendDeveloper_CV.pdf'
        ...
        fetch(filePath)
            ...
            .then((blob) => {
                ...
                link.href = url
                link.download = 'HuynhDuyPhuc_CV_FrontendDeveloper.pdf'
    ...
    return (
        <EffectSection title="About Me" textAlign='text-left' className="py-16 md:py-24 text-[20px] z-[-1]">
